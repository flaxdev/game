function U = getOkada(params, Stations, Terrain)

% ###################################
x0 = (Stations(2) - params(1))/1000;
y0 = (Stations(1) - params(2))/1000;
z0 = (Stations(3)-params(3))/1000;

XROT = [cosd(params(4)) -sind(params(4)) 0 
    sind(params(4)) cosd(params(4)) 0
    0 0  1];
